...
const toggle = async () => {
  ...
  return (
    <div className="block rounded-lg p-2 shadow-xs shadow-black border border-1  font-montserrat text-primary bg-white hover:bg-secondary">
      <div className="relative">
          {
 ...
 (
     ...
     <Link href={`/en/booking/${id}`}>
      ...
      className="h-80 md:h-[350px] lg:h-[500px] w-full rounded-md object-cover"
...
export default function HotelCardsHome() {
  ...
  return (
    <div className="flex flex-col gap-4 mx-2 lg:mx-40">
