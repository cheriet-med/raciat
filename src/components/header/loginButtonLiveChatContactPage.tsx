      ...
      {/* Button to open the dialog */}
       <button
                                 ...
                                 onClick={() => setIsOpen(true)}
                                  className="p-1 flex gap-4 justify-center items-center bg-primary w-full h-16 text-yel rounded-lg shadow-lg hover:bg-yel transition-all bg-opacity-80 border border-spacing-1 border-white"
                                >
                                  <RiChatSmileAiLine size={32} className='text-white '/>
                                <p className='text-white font-bold'>الدردشة المباشرة</p>
