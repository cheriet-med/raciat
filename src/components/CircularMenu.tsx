...
export default function VerticalMenu() {
  ...
  const menuItems: MenuItem[] = [
    { label: "الرئيسية", icon: <IoIosHome />, href: "/en/" },
    { label: "عقارات", icon: <FaBuilding />,  href: "/en/booking" },
    { label: status === "authenticated" ? "حسابي" :"دخول إلى الحساب", icon: <FaUser />, href: status === "authenticated" ? "/en/account" :"/en/login" },
    //{ label: "My Reviews", icon: <MdOutlineRateReview />, href: status === "authenticated" ? "/en/account" :"/en/login" },
    { label: "مدونة", icon: <SiMicrodotblog />, href: "/en/blog" },
    { label: "معلومات عنا", icon: <SiInformatica />, href: "/en/about-us" },
    { label: "إتصل بنا", icon: <RiContactsFill />, href: "/en/contact-us"},
  ];
      ...
      >
        ...
        >
          <p className="text-white uppercase font-montserrat text-xs">
            حقوق الطبع والنشر
 &copy; جميع الحقوق محفوظة لعام 2025

          </p>
          <div className="flex gap-4">
            <Link href="/en/cookies-policy" className="text-white uppercase font-montserrat text-xs hover:text-primary transition-colors">إعدادات ملفات تعريف الارتباط</Link>
            <Link href="/en/privacy-policy" className="text-white uppercase font-montserrat text-xs hover:text-primary transition-colors">سياسة الخصوصية</Link>
            <Link href="/en/terms-and-conditions" className="text-white uppercase font-montserrat text-xs hover:text-primary transition-colors">الشروط والأحكام</Link>
          </div>
        </div>
      </div>
