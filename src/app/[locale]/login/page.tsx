    ...
    <div className="fixed inset-0 bg-[url('/bg/19.jpg')] bg-no-repeat bg-center bg-cover overflow-auto">
      <div className="min-h-screen flex items-center justify-center p-4 font-montserrat">
        ...
        >
          ...
          <div className="space-y-4">
            <div>
              <input
                ...
                className="w-full px-4 py-3 border border-yel rounded-lg focus:outline-none focus:ring-2 focus:ring-yel bg-yel placeholder:text-gray-200 text-a"
            ...
            >
              {isLoading ? (
                <>
                 دخول <FaCircleNotch className="animate-spin" />
                </>
              ) : (
                "دخول"
              )}
          ...
          <p className="text-white py-2 text-center">أو</p>
          <div className="flex flex-col gap-3">
           <Link href="/signin">
            <button  className="w-full py-3 rounded-lg font-medium transition-colors text-white border border-white hover:bg-secondary">
            سجل باستخدام البريد الإلكتروني
                    ...
                    <div className="w-full py-3 px-4 rounded-lg font-medium transition-colors text-white border border-white flex items-center justify-center gap-3 hover:bg-secondary cursor-pointer"
